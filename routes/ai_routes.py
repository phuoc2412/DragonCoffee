...
def chatbot_api():
    ...
    try:
        # Gọi hàm get_response (đã được alias trỏ đến hàm custom chatbot)
        ...
        # Trả về kết quả từ custom chatbot
        # **Đảm bảo kết quả trả về đúng cấu trúc mong đợi:**
        # {'response': str, 'intent': str, 'entities': dict, 'image_results': list}
        response_payload = {
            'success': True,
            ...
            'image_results': bot_response_data.get('image_results', []) # Luôn trả về list ảnh
        }
